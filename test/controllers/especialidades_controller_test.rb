...
class EspecialidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create especialidade" do
    assert_difference("Especialidade.count") do
      post especialidades_url, params: { especialidade: { area_id: @especialidade.area_id, descricao: @especialidade.descricao } }
    end
  ...
  test "should update especialidade" do
    patch especialidade_url(@especialidade), params: { especialidade: { area_id: @especialidade.area_id, descricao: @especialidade.descricao } }
